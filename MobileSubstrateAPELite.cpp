...
extern "C" void *APEFindSymbol(struct mach_header *image, const char *symbol)
{
...
#include "mobilesubstrate/MobileHooker.mm"

extern "C" void *APEPatchCreate(const void *patchee, const void *address)
{
	void *result = NULL;
	MSHookFunction((void*)patchee, (void*)address, &result);
	return result;
}
